...
return array(
    ...
    // Zend_Validate_Db
    "No record matching '%value%' was found" => "Nenhum registro com '%value%' foi encontrado",
    "A record matching '%value%' was found" => "Foi encontrado ao menos um registro com '%value%'",
);
