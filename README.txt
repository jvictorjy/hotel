...
O banco de dados est·á na pasta /docs. Para conectar o banco de dados com a
...
Esse È um exemplo do VHOST para você poder setar para iniciar o projeto.
Obs. Deve sempre apontar para a pasta public.

<VirtualHost *:80>
   DocumentRoot “/folder/Projetos/NewFolder/public"
   ServerName NewFolder.local

   <Directory “/folder/Projetos/NewFolder/public">
